...
# Dati incorporati: Onomastici (366), Curiosità (200) — nessun file esterno richiesto
#
...
CURIOSITA_DB = [
    ...
    "A Putignano il vero cuore del Carnevale batte nei sottani. I 'Jos'r', nel dialetto locale, sono le antiche cantine o i piccoli locali a piano terra del centro storico. Durante il periodo di festa, questi spazi vengono aperti e trasformati in punti di ritrovo spontanei dove si balla, si beve vino e si offrono taralli a chiunque passi.",
    "Subito dopo il funerale del Carnevale, le strade di Putignano si popolano di strane figure sospese. Sono le 'Quarantane', sette bamboline di pezza vestite a lutto e appese a fili tesi tra i balconi. Rappresentano la moglie del Carnevale defunto e le sette settimane della Quaresima, fungendo da pittoresco calendario fino a Pasqua.",
    "Sapevate che i primissimi coriandoli lanciati a Putignano non erano di carta? Secoli fa, durante i festeggiamenti, si lanciavano i semi della pianta del coriandolo ricoperti da un guscio di zucchero colorato. Solo nell'Ottocento si passò a utilizzare i ritagli di carta per ragioni economiche, mantenendo però il nome della spezia.",
    "A Putignano la sera la macelleria non chiude ma accende il fuoco. Come in molti paesi delle Murge, sopravvive la meravigliosa tradizione del 'Fornello'. Si entra in macelleria, si sceglie la carne cruda dal bancone e il macellaio la cuoce al momento in speciali forni verticali a legna per consumarla sul posto in un'atmosfera rustica.",
    "Misteri sotto le Chianche. Le leggende locali narrano che il sottosuolo del centro storico di Putignano sia attraversato da un antico passaggio segreto. Un tunnel sotterraneo che avrebbe collegato in epoca medievale la Chiesa Madre con le uscite della città, permettendo ai religiosi di fuggire inosservati in caso di assalti.",
    "L'undici novembre a Putignano l'aria profuma di fritto e di mosto. Per la festa di San Martino, che celebra l'apertura delle botti del vino novello, le famiglie preparano le 'pettole': soffici palline di pasta lievitata fritte in olio bollente e spesso rotolate nello zucchero per addolcire i primi freddi autunnali.",
    "Il giorno di Santo Stefano a Putignano non è solo dedicato alle Propaggini, ma anche al commercio. Fin dal Medioevo questa giornata coincideva con una grande fiera agricola e del bestiame. Era l'occasione in cui i contadini scendevano in paese per vendere i propri prodotti e dare così inizio al clima di festa.",
    "Entrando nella Chiesa di San Pietro Apostolo, alzando lo sguardo verso la cantoria, troneggia un magnifico organo a canne ligneo risalente al Settecento. Impreziosito da intagli dorati, è un capolavoro di ebanisteria il cui suono potente accompagna da secoli le liturgie più importanti della comunità.",
    "A Putignano la Pasqua ha una forma precisa, quella della 'Scarcella'. È un grande biscotto di pasta frolla o pasta di pane dolce, spesso a forma di colomba o cestino. La sua particolarità è l'uovo sodo con tutto il guscio incastonato al centro della pasta, antico e potente simbolo di rinascita e fertilità.",
    "Oltre alla cartapesta c'è un'altra antica tradizione artigianale a Putignano: l'arte dell'intreccio. I contadini più anziani erano maestri nel realizzare panieri e ceste intrecciando pazientemente i giovani e flessibili rami di ulivo e le canne, creando contenitori robusti usati per la raccolta di fichi e ciliegie.",
    "L'arrivo dell'acqua pubblica in Puglia fu un evento epocale. Anche a Putignano sopravvivono ai bordi delle strade storiche le vecchie fontanine pubbliche in ghisa, affettuosamente chiamate 'cape de firr'. Testimoniano un'epoca in cui avere l'acqua potabile a due passi da casa rappresentava un lusso straordinario.",
    "Qual è il piatto ufficiale del Martedì Grasso a Putignano? Non si discute: sono gli 'ziti spezzati a mano', conditi con un ricchissimo ragù di carne mista. Una preparazione lunga e lenta che bolliva per ore sui fornelli fin dalle prime luci dell'alba, in vista dell'ultima vera abbuffata prima del digiuno quaresimale.",
    "Le confraternite laiche a Putignano hanno sempre avuto un ruolo sociale fondamentale. La più antica è quella del Santissimo Sacramento, i cui membri si distinguevano per le mantelline bianche. Erano loro a organizzare le solenni processioni cittadine e a gestire fondi di mutuo soccorso per i cittadini più poveri.",
    "Nelle antiche masserie putignanesi il Natale iniziava con un tronco gigante. Era il 'Ceppo di Natale', un grosso pezzo di legno di quercia che veniva acceso nel camino la sera della Vigilia. Doveva ardere lentamente, senza mai spegnersi, fino al giorno dell'Epifania per simboleggiare calore e protezione per il nuovo anno.",
    "Fuori dal centro abitato di Putignano il cimitero monumentale nasconde vere e proprie opere d'arte. Le cappelle gentilizie delle antiche famiglie borghesi sono piccoli capolavori di architettura, adornati da statue in marmo bianco e angeli piangenti scolpiti da rinomati artisti pugliesi dell'Ottocento.",
    "Per accompagnare le tarantelle dialettali a Putignano si usava uno strumento rudimentale ma dal suono ipnotico: il 'cupa cupa'. È un tamburo a frizione, realizzato con una pentola di terracotta coperta da una pelle tesa in cui è inserita una canna. Sfregandola con la mano umida si produce un suono sordo e inconfondibile.",
    "Con tutte quelle grotte naturali Putignano è l'habitat perfetto per i pipistrelli. In passato le cavità carsiche delle campagne erano la dimora di enormi colonie di questi mammiferi alati, utilissimi e rispettati dai contadini per la loro capacità di tenere lontane le zanzare e gli insetti dannosi dalle colture.",
    "Dimenticate le classiche orecchiette, a Putignano si mangiano i 'Cingoli'. Si tratta di un tipo di pasta fresca di semola di grano duro, simile ai cavatelli ma leggermente più lunga e incavata usando due dita. Sono perfetti per trattenere sughi corposi, specialmente quelli a base di funghi cardoncelli delle Murge.",
    "La devozione per Maria Santissima del Pozzo raggiunge l'apice in agosto. La grande statua della Madonna non viene portata semplicemente a spalla, ma troneggia su un sontuoso Carro Trionfale alto svariati metri. Questo mezzo imponente viene spinto a mano per le vie della città tra due ali di folla festante.",
    "Il monastero delle Clarisse nel borgo antico era un mondo a sé stante. Le monache di clausura di Putignano contribuivano all'economia della città in modo dolce: erano rinomate per la preparazione di biscotti di pasta di mandorla e dolcetti preziosi che venivano scambiati attraverso la ruota del convento durante le festività.",
    "Tra febbraio e marzo le campagne di Putignano si tingono di bianco e rosa tenue. È lo spettacolo della fioritura dei mandorli, una coltivazione storicamente vitale per questa zona. Le mandorle locali sono infatti l'ingrediente principale della maggior parte dei dolci tradizionali e dei celebri confetti pugliesi.",
    "I poeti contadini del giorno di Santo Stefano salgono sul palco con un abito rigoroso. L'abbigliamento tradizionale prevede un completo in velluto a coste, camicia, gilet, un fazzoletto rosso annodato al collo e in testa la tipica 'coppola'. È un omaggio fiero e nostalgico alle radici puramente agricole della festa.",
    "Prima dell'invenzione dei frigoriferi il ghiaccio si conservava sottoterra. Sfruttando la natura carsica del suolo di Putignano, venivano create delle 'neviere': profonde cavità naturali o scavate a mano dove la neve invernale veniva pressata e isolata con la paglia, per poter avere blocchi di ghiaccio disponibili durante la calura estiva.",
    "I balconi dei palazzi storici putignanesi sono decorati con ringhiere eleganti e complesse. Sono il frutto del lavoro degli antichi mastri ferrai del paese, artigiani capaci di piegare il ferro battuto incandescente per creare volute, decorazioni floreali e cancellate che ancora oggi impreziosiscono l'architettura del centro storico.",
    "Passeggiando nei vicoli si possono ammirare portoni secolari. Il legno massiccio, intagliato a mano dai falegnami locali, spesso nasconde stemmi nobiliari sbiaditi e antichi batacchi in ottone a forma di mano o di volto di leone, che per secoli hanno annunciato l'arrivo dei visitatori nelle dimore putignanesi.",
    "Le reliquie di Santo Stefano non arrivarono a Putignano per caso ma per fuggire da Monopoli a causa delle incursioni saracene. Furono portate nell'entroterra per essere protette dai Cavalieri di Malta in una vera e propria operazione di salvataggio spirituale e militare dell'epoca.",
    "Si racconta che nel milleseicento Putignano fu miracolosamente risparmiata da una terribile epidemia di peste che decimò i paesi vicini. I cittadini attribuirono la salvezza alla protezione di San Michele Arcangelo e da allora la devozione verso la sua grotta santuario crebbe a dismisura.",
    "Prima dell'avvento dell'industria tessile moderna le donne putignanesi tessevano in casa. Utilizzando vecchi telai di legno producevano resistenti tessuti in lino e canapa, coltivati nelle campagne circostanti, per confezionare il prezioso corredo nuziale delle figlie.",
    "Quando i cavalli e i muli erano l'unico mezzo di trasporto, l'artigianato del cuoio a Putignano era fiorente. I mastri sellai creavano non solo finimenti da lavoro per l'agricoltura ma anche selle eleganti e decorate per le carrozze dei signorotti locali e dei governatori.",
    "Non tutto il centro storico è rigorosamente bianco. Alcuni palazzi nobiliari si distinguono per il loro colore rosso scuro o ocra intenso. Questo pigmento naturale veniva utilizzato dalle famiglie più abbienti per distinguere la propria dimora da quelle umili imbiancate a calce viva.",
    "Prima dell'acquedotto l'acqua piovana era un bene vitale. Ogni palazzo signorile o casa a corte di Putignano nascondeva nel proprio atrio una grande cisterna interrata, collegata ai tetti tramite tubi di coccio per immagazzinare l'acqua da usare durante i lunghi mesi secchi estivi.",
    "Il Mercoledì delle Ceneri segna la fine del Carnevale e a Putignano viene vissuto con grande intensità. Nelle chiese la cenere imposta sulla fronte dei fedeli veniva tradizionalmente ricavata bruciando i rami d'ulivo benedetti l'anno precedente durante la Domenica delle Palme.",
    "In netto contrasto con il frastuono carnevalesco il Venerdì Santo a Putignano è il giorno del silenzio assoluto. Le statue lignee dei Misteri che rappresentano la Passione di Cristo vengono portate in processione al buio, illuminate solo da fiaccole e accompagnate da marce funebri.",
    "La musica popolare a Putignano non è solo legata al Carnevale. Durante la mietitura del grano e la vendemmia i contadini scandivano la fatica cantando stornelli a dispetto e ballando una versione locale della tarantella, caratterizzata da passi veloci e saltellati per scacciare la stanchezza.",
    "Le grandi masserie del territorio putignanese non erano semplici fattorie ma veri e propri avamposti difensivi. Dotate di alte mura di cinta e a volte di piccole torri di avvistamento, servivano a proteggere i raccolti, gli animali e i contadini dalle razzie dei briganti.",
    "I chilometri di muretti a secco che circondano Putignano non sono solo confini agricoli. Tra le fessure delle pietre senza cemento si nasconde un micro-ecosistema perfetto che offre riparo a lucertole, piccoli mammiferi, insetti e piante spontanee fondamentali per la biodiversità locale.",
    "L'inaugurazione della stazione ferroviaria all'inizio del Novecento cambiò il volto di Putignano. L'arrivo dei treni a vapore permise alla città di esportare i propri prodotti agricoli e l'olio d'oliva molto più velocemente verso i porti di Bari e Taranto, aprendosi al commercio nazionale.",
    "Lavorare nei frantoi ipogei sotto il centro storico era durissimo. I frantoiani chiamati 'trappetari' vivevano per mesi sottoterra in ambienti umidi e poco illuminati insieme ai muli bendati, che facevano girare ininterrottamente le pesanti macine di pietra calcarea per schiacciare le olive.",
    "A fine estate i tetti piatti delle case putignanesi si ricoprivano di graticci di canne. Servivano per far essiccare i fichi al sole cocente del sud, che venivano poi spaccati a metà, farciti con una mandorla tostata e semi di finocchietto per diventare un dolce energetico invernale.",
    "Per ottenere l'olio migliore a Putignano le olive venivano e spesso vengono ancora raccolte rigorosamente a mano. Questa tecnica detta 'brucatura' evita che il frutto si ammacchi cadendo a terra, garantendo una spremitura perfetta e un olio extravergine di altissima qualità.",
    "Quando le donne portavano le enormi forme di pane a cuocere nei forni pubblici dovevano riconoscerle. Per questo ogni famiglia possedeva un timbro di legno intagliato con le proprie iniziali da imprimere a secco sull'impasto crudo, garantendo di riportare a casa la pagnotta giusta.",
    "Prima della luce elettrica il centro storico di Putignano aveva un'atmosfera da romanzo. Le strade principali erano illuminate da eleganti lampioni a gas di città accesi uno ad uno ogni sera da una figura ormai scomparsa, il lampionaio che passava con la sua lunga asta accenditore.",
    "La piazza dove oggi si trova il municipio un tempo aveva una funzione molto meno formale. Nei giorni di fiera era lo spiazzo sterrato destinato al grande mercato del bestiame, dove si contrattava la compravendita di cavalli, mucche e pecore suggellando gli accordi con vigorose strette di mano.",
    "Nell'Ottocento i fitti boschi di fragno e le grotte intorno a Putignano offrivano un nascondiglio perfetto per i briganti post-unitari. I racconti dei nonni narrano ancora oggi di tesori rubati e nascosti in cavità inesplorate e di imboscate lungo le mulattiere che portavano in città.",
    "La roccia delle Murge non serve solo per costruire muretti. Generazioni di scalpellini putignanesi hanno estratto e lavorato la dura pietra calcarea bianca per realizzare veri e propri merletti di pietra, portali decorati, stemmi nobiliari e i caratteristici comignoli tondi dei tetti antichi.",
    "Le numerose edicole votive che costellano i muri di Putignano non erano solo segni di devozione. In assenza di segnaletica stradale queste piccole nicchie affrescate o contenenti stampe sacre fungevano da veri e propri punti di riferimento per orientarsi nell'intrico dei vicoli del borgo.",
    "La festa della Candelora il due febbraio non è solo legata alla pantomima dell'orso. I vecchi agricoltori putignanesi scrutano attentamente il cielo in quel giorno perché, secondo un proverbio locale, se il tempo è sereno si è fuori dall'inverno ma se piove o tira vento la primavera è ancora lontana.",
    "Quando il cielo estivo si faceva nero e minacciava tempesta o grandine rovinosa per i raccolti, il campanaro della Chiesa Madre si precipitava in cima alla torre. Suonava le campane a distesa convinto che le potenti onde sonore potessero spaccare le nuvole cariche di grandine e salvare la vendemmia.",
    "Il dialetto putignanese è ricchissimo di proverbi legati al ciclo delle stagioni. Frasi antiche e rimate che dettavano le regole della semina, della potatura e del raccolto, fungendo da vero e proprio manuale agricolo tramandato oralmente di padre in figlio nei campi.",
    "Prima dell'avvento della plastica i bambini putignanesi si costruivano i giochi da soli. Usavano rocchetti di filo di legno, fionde ricavate da rami biforcuti di ulivo o bamboline fatte annodando vecchi stracci, dimostrando una creatività e un'inventiva incredibili con pochissimi mezzi a disposizione.",
    "Se osservate attentamente le chiavi di volta dei portoni più antichi di Putignano noterete volti grotteschi scolpiti nella pietra. Si tratta di mascheroni apotropaici, figure dall'espressione mostruosa o canzonatoria che, secondo la credenza popolare, servivano a spaventare e tenere lontani gli spiriti maligni dalle abitazioni.",
    "Oltre al Carnevale, la traslazione di Santo Stefano viene celebrata anche in modo solenne. L'icona del Santo e il reliquiario vengono portati in processione per le strade del paese accompagnati dal clero, dalle confraternite cittadine e dalle note delle prestigiose bande musicali pugliesi.",
    "Prima che esplodesse la moda dei carri in cartapesta su grande scala, a Putignano sfilavano i 'minicubbi'. Erano piccoli palchi montati su carretti o Ape Car, decorati in modo artigianale dai ragazzi dei vari quartieri, che li usavano come base per lanciare coriandoli e suonare musica per le strade.",
    "La natura calcarea e apparentemente brulla attorno a Putignano nasconde fioriture spettacolari. In primavera, tra i pascoli rocciosi, sbocciano decine di specie diverse di orchidee selvatiche endemiche, un tesoro botanico preziosissimo che attira fotografi naturalisti ed escursionisti da tutta Europa.",
    "Il Natale a Putignano ha il sapore inconfondibile delle cartellate. Sottilissime strisce di pasta frolla fritte, arrotolate a formare delle piccole rose coronate e poi abbondantemente immerse nel vincotto caldo di fichi o di uva, creando un dolce croccante e appiccicoso irrinunciabile per le feste.",
    "Il diciannove marzo a Putignano la sera si illumina con i fuochi. In occasione della festa di San Giuseppe e della vigilia della primavera, nei quartieri periferici e nelle campagne si accendono grandi falò propiziatori costruiti accatastando rami secchi di potatura, attorno ai quali si fa festa e si suona.",
    "Le nonne putignanesi erano maestre di pazienza e precisione. Molte donne passavano le ore della controra estiva a intrecciare fili di cotone sui cuscini da tombolo, creando pizzi e merletti delicatissimi che andavano ad impreziosire lenzuola, tovaglie da altare e gli abiti del giorno di festa.",
    "Il piatto povero per eccellenza della cultura contadina putignanese è la purea di fave secche servita con le cicorie selvatiche. Un contrasto perfetto tra la dolcezza e la cremosità del legume decorticato e il gusto piacevolmente amaro della verdura raccolta spontaneamente nei campi, il tutto irrorato da olio crudo.",
    "Fino agli anni sessanta il vero motore dell'economia rurale putignanese era il mulo. Questo animale rustico, instancabile e testardo, era essenziale per arare i terreni sassosi delle Murge, per trainare i carri carichi di raccolto e per far girare le ruote dei mulini e dei frantoi cittadini.",
    "Grazie alla sua altitudine e alla particolare conformazione del territorio, in autunno Putignano si sveglia spesso avvolta in una fitta e affascinante nebbia. Banchi di vapore che salgono dalle gravine umide e ammantano i tetti del centro storico di un'atmosfera sospesa e quasi nordica, prima che il sole li dissolva.",
    "Se cercate la maschera simbolo di Putignano non dovete aspettare il Carnevale. In Piazza Aldo Moro si trova una statua in bronzo a grandezza naturale che raffigura Farinella in una posa dinamica e danzante. È diventata il punto di ritrovo preferito per le foto ricordo dei turisti di passaggio.",
    "Nella medicina popolare putignanese l'olio extravergine non serviva solo per condire. Veniva usato scaldato per curare i mal d'orecchio dei bambini, mescolato con erbe per massaggiare i dolori muscolari o perfino per il misterioso rito dell'eliminazione del 'malocchio' fatto cadere in gocce in un piatto d'acqua.",
    "Nonostante il clima caldo, i balconi in ferro battuto del centro storico di Putignano esplodono di colori da maggio a settembre. Le signore del borgo fanno a gara per coltivare gerani rigogliosi, begonie e profumatissime piante di basilico nei classici vasi di terracotta, annaffiandoli religiosamente ogni sera al tramonto.",
    "Una delle figure più rispettate della vecchia Putignano era il trainiere, ovvero il conducente dei grandi carri trainati da cavalli. Questi uomini trasportavano merci da una città all'altra, dormivano spesso all'aperto sotto il carro e tornavano in paese portando non solo provviste ma anche le notizie dai paesi lontani.",
    "A Putignano, come in gran parte del meridione, il pane è considerato quasi sacro. Un'antica regola non scritta imposta dai nonni prevede che, se un pezzo di pane cade inavvertitamente a terra, debba essere raccolto e baciato prima di essere scartato, in segno di rispetto per la fatica necessaria a produrlo.",
    "Nelle scampagnate putignanesi e nelle sere dei fornelli non manca mai la 'zampina'. È un particolare insaccato fresco, una salsiccia sottile e arrotolata a spirale preparata con carne mista tritata finemente, formaggio, pomodoro e basilico. Cotta rigorosamente sulla brace di legna sprigiona un profumo a cui è impossibile resistere.",
    "Ogni primavera Putignano accoglie il ritorno scassato delle rondini e dei balestrucci. Questi uccelli migratori hanno l'abitudine secolare di nidificare sotto gli ampi cornicioni dei palazzi storici e sotto le volte delle porte cittadine, riempiendo il cielo del borgo con i loro voli acrobatici e i loro richiami continui.",
    "Durante le feste patronali sui banchi del mercato facevano la loro comparsa piccoli oggetti colorati: i fischietti in terracotta. Modellati a mano dagli artigiani locali e dipinti con colori vivaci, rappresentavano galletti, carabinieri o figure umane stilizzate ed erano il giocattolo economico preferito per far divertire i bambini.",
    "Fino a pochi decenni fa la dichiarazione d'amore a Putignano si faceva in musica. Era consuetudine per i giovani innamorati organizzare una serenata notturna sotto la finestra o il balcone della ragazza desiderata, ingaggiando suonatori di chitarra e fisarmonica per farsi notare dal futuro suocero.",
    "A Putignano la domenica mattina ha un ritmo speciale. Dopo la messa il corso principale si riempie di cittadini vestiti con l'abito buono per la classica passeggiata. È il momento in cui si commentano le notizie della settimana, si organizzano le sfilate del Carnevale e ci si ferma al bar per l'aperitivo.",
    "Se i ricchi avevano pozzi privati, il popolo si affidava alle cisterne pubbliche. Nelle piazze e nei larghi di Putignano erano state scavate grandissime vasche ipogee che raccoglievano l'acqua piovana filtrata dalla pietra. Nei mesi di siccità le donne vi attingevano con secchi di rame calati pazientemente con lunghe funi.",
    "Nei caldi mesi estivi a Putignano vige la regola ferrea della 'controra'. Dalle due alle cinque del pomeriggio le strade si svuotano, i negozi abbassano le saracinesche e il silenzio regna sovrano. È il tempo del riposo al fresco delle case di pietra, necessario per recuperare le energie dopo la mattinata di lavoro.",
    "Alzando gli occhi al cielo sopra i tetti più alti di Putignano si possono notare piccoli rapaci in volo stazionario. Sono i falchi grillai, una specie protetta che ha trovato l'habitat perfetto tra le nicchie dei campanili pugliesi e che sorveglia le campagne circostanti contribuendo al controllo dei piccoli roditori.",
    "Nei pomeriggi d'inverno i vecchi circoli e i bar di Putignano risuonano di un rumore inconfondibile: i pugni battuti sui tavolini. Sono le accese e animate partite a carte, rigorosamente a scopa o briscola, dove i giocatori locali sfidano gli amici di sempre in un misto di concentrazione, dialetto stretto e sonore risate.",
    "Una volta a Putignano il baule del corredo era una questione di prestigio familiare. Veniva preparato con anni di anticipo e doveva contenere dozzine di lenzuola e camicie da notte in puro lino bianco, rigorosamente ricamate a mano, che venivano esposte orgogliosamente alle amiche pochi giorni prima del matrimonio.",
    "Tutti conoscono la Chiesa Madre, ma Putignano custodisce anche piccole perle nascoste come la chiesetta di Santo Stefano 'piccolo'. Situata all'esterno dell'antico nucleo murato, è uno degli edifici di culto più vecchi della città e rappresenta la prima vera traccia tangibile della presenza dei Cavalieri di Malta nel territorio.",
    "L'ingegno putignanese non si è limitato alla cartapesta. Negli anni del boom economico la città ha visto nascere importanti officine metalmeccaniche specializzate nella creazione e modifica di attrezzi agricoli su misura, progettati appositamente per lavorare i terreni sassosi e difficili dell'altopiano delle Murge.",
    "In inverno i contadini putignanesi si armano di guanti spessi e coltellini per una missione spinosa. Si avventurano nelle campagne per raccogliere i cardi selvatici, piante ispide e pungenti dal cuore tenero e amarognolo, che, una volta puliti con grande fatica, diventano i protagonisti di zuppe calde e saporite.",
    "A Putignano ogni piazza diventa un teatro durante i mesi invernali. L'amministrazione e i gruppi organizzatori montano palcoscenici in tubi innocenti e legno in vari punti strategici del centro. Queste strutture temporanee ospitano i reading dei Propagginanti, i concerti serali e i dibattiti dell'Accademia delle Corna.",
    "Prima dei videogiochi, i bambini di Putignano si sfidavano nelle strade a colpi di 'curlo'. Si trattava di una robusta trottola in legno massiccio, spesso intagliata artigianalmente, che veniva fatta girare vigorosamente avvolgendovi attorno uno spago e lanciandola sulle chianche lisce con un movimento secco del polso.",
    "Anche se più famosa per l'olio, Putignano vanta un'ottima tradizione vitivinicola. Nelle campagne a sud del paese, dove la terra si fa rossa, i vigneti accarezzati dal sole e dal vento di collina producono uve eccellenti, regalando un vino Primitivo corposo e strutturato perfetto per accompagnare le ricche carni locali.",
    "Passeggiando nei vicoli più antichi si possono notare alcune finestre protette da fitte grate in legno sporgenti e ricurve. Sono le cosiddette 'gelosie', un retaggio architettonico spagnolo che permetteva alle donne di casa, o alle monache di clausura, di osservare la strada senza essere viste dall'esterno.",
    "Vicino ai monasteri e in alcuni palazzi storici di Putignano era un tempo presente la 'ruota dei proietti'. Un cilindro rotante in legno inserito nel muro che permetteva alle madri disperate di abbandonare i neonati in modo anonimo e sicuro, affidandoli alle cure delle suore o degli orfanotrofi locali per garantirne la sopravvivenza.",
    "A metà luglio Putignano celebra un'altra ricorrenza religiosa molto sentita: la Madonna del Carmine. In quei giorni il caldo estivo viene spezzato dalle celebrazioni nei pressi dell'omonima chiesa periferica, con venditori di noccioline, processioni solenni e i classici fuochi d'artificio sparati al calare del sole.",
    "Il bianco accecante del centro storico di Putignano non è un caso, ma frutto di manutenzione costante. Ogni anno, tradizionalmente prima di Pasqua o in estate, le famiglie usavano la calce viva per rinfrescare e disinfettare i muri esterni delle proprie case, mantenendo il borgo immacolato e luminoso.",
    "Se vi capita di guidare di notte nelle strade provinciali fuori Putignano, potreste scorgere un bagliore fuggente. Sono le volpi, abilissime predatrici notturne che popolano i boschi di fragno e le macchie cespugliose delle Murge, mantenendo l'equilibrio ecologico della zona cacciando piccoli animali.",
    "Oltre al mercato agricolo settimanale, Putignano ha visto nascere eventi dedicati agli amanti del vintage. In determinati periodi dell'anno le piazze ospitano vivaci mercatini dell'usato e dell'antiquariato, dove vecchie macchine da cucire, monete antiche e stampe d'epoca passano di mano in mano in un rito continuo di baratto.",
    "Quando il caffè in grani era un lusso per pochi, a Putignano la colazione aveva un aroma diverso. Nelle case contadine si preparava la bevanda scura tostando l'orzo o i ceci nel camino, che venivano poi macinati per ottenere un surrogato del caffè economico, caldo e rassicurante da inzuppare con il pane secco.",
    "Oltre al tombolo, le donne putignanesi eccellevano nella tecnica dello 'sfilato pugliese'. Questa complessa arte del ricamo consisteva nello sfilare letteralmente i fili dalla trama del tessuto di lino per poi ricamarci sopra motivi geometrici vuoti, creando effetti di trasparenza straordinari per tovaglie e tende di lusso.",
    "Fino agli anni ottanta le colline attorno a Putignano risuonavano di una melodia pastorale. Erano le grandi mandrie di mucche podoliche e pecore che si spostavano tra i pascoli brulli, ognuna con un campanaccio di metallo al collo il cui suono ritmato permetteva ai pastori di localizzarle facilmente tra la fitta nebbia.",
    "A Putignano, come in gran parte della provincia italiana, il salone del barbiere non era solo un luogo dove tagliare i capelli. Era un vero e proprio salotto per soli uomini, dove tra schiuma da barba e rasoi a mano libera si discuteva di politica locale, si organizzavano affari e si gettavano le basi per i carri allegorici.",
    "Nelle vecchie cucine putignanesi o nei trulli di campagna non mancavano mai le trecce. Non di capelli, ma di aglio bianco e peperoncini rossi appesi alle travi del soffitto ad essiccare. Oltre ad essere ingredienti fondamentali della cucina locale, si riteneva portassero fortuna e scacciassero le influenze negative.",
    "I maestri cartapestai di Putignano non lavorano solo per il Carnevale. Durante il periodo natalizio la loro arte si fa in miniatura per la realizzazione di suggestivi presepi artigianali. Le statuine, modellate rigorosamente in cartapesta dipinta a mano, raffigurano spesso scene di vita quotidiana contadina anziché i classici pastori.",
    "La lingua di Putignano non è usata solo per parlare al mercato, ma è nobilitata dalla letteratura. Esiste una fitta schiera di poeti dialettali locali che, attraverso libri e raccolte, hanno fissato su carta proverbi, filastrocche e sonetti romantici, preservando una grammatica e un vocabolario che altrimenti andrebbero perduti.",
    "Una delizia assoluta delle sagre e delle feste di piazza a Putignano è il 'caciocavallo impiccato'. Una grande forma di formaggio stagionato viene legata con una fune e sospesa lentamente sopra i carboni ardenti. Man mano che la base si fonde, il formaggio fuso viene spalmato su fette di pane pugliese bruscato.",
    "L'architettura del centro storico di Putignano ha soluzioni ingegnose. Per contrastare la spinta dei palazzi in pietra che si affacciano su vicoli molto stretti, gli antichi muratori costruivano piccoli archi rampanti che collegano le due facciate opposte. Fungono da tiranti antisismici e creano scorci fotografici incantevoli.",
    "L'agricoltura locale ha ritmi antichi. Alla fine dell'autunno, mentre la natura si prepara al riposo, i contadini putignanesi si dedicano alla semina dei legumi resistenti al freddo: ceci, cicerchie e fave. Riposando sotto terra durante le gelate invernali, spunteranno rigogliosi ai primi tepori della primavera.",
    "Fuori dalle porte delle case a piano terra del borgo antico si trovano spesso piccoli muretti o gradini in pietra levigata. Erano le 'panchine' naturali dove le donne si sedevano la sera d'estate per rammendare o pulire le verdure, chiacchierando da una porta all'altra e creando un forte senso di comunità di vicinato.",
    "Novembre a Putignano è il mese del ringraziamento agricolo. Il momento più atteso dalle famiglie è l'arrivo dell'olio 'nuovo' appena franto, di colore verde smeraldo e dal sapore intenso e piccantino. Viene celebrato versandolo crudo, in quantità generosa, su semplici fette di pane tostato sul fuoco.",
    "Il Carnevale di Putignano non invecchia mai perché si rinnova continuamente. Alla fine di ogni edizione, mentre la Campana dei Maccheroni smette di suonare, i maestri cartapestai più anziani e i giovani apprendisti si scambiano uno sguardo d'intesa: nella mente di tutti, l'idea per il carro dell'anno successivo è già nata.",
]
...
# ============================================================
# MODULO CURIOSITÀ  (dati incorporati da 200_curiosità.docx)
# ============================================================
